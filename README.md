...
8. Функцию, сортирующую транзакции по заданному пользователем слову в поле description.
9. Функция, подсчитывающую количество транзакций по категориям.
10. Функцию main в модуле main.py, воспроизводящую основной функционал банковского приложения.
